...
The Unsafe Content detector achieved 73.66\% F1 with a 7.81\% FPR. The precision penalty arises from high lexical overlap between benign discussions of safety topics and actual toxic intents---a known challenge for keyword-based detectors. The FPR remains within the $<10\%$ enterprise threshold.
