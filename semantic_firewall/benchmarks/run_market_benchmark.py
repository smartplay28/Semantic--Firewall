...
# Allow running as a standalone script: `python semantic_firewall/benchmarks/run_market_benchmark.py`
...
def main():
    ...
    parser.add_argument("--dataset", default="data/datasets/benchmark_from_tests.jsonl")
    parser.add_argument("--leaderboard-output", default="data/results/leaderboard.json")
    parser.add_argument("--results-output", default="data/results/benchmark_results.json")
    ...
    if not dataset_path.exists():
        raise FileNotFoundError(
            f"Dataset not found at {dataset_path}. Run: python semantic_firewall/benchmarks/extract_dataset_from_tests.py"
        )
    ...
    leaderboard_payload = {
        "generated_by": "semantic_firewall/benchmarks/run_market_benchmark.py",
