...
def main():
    ...
    parser.add_argument("--input", default="data/datasets/benchmark_from_tests.jsonl")
    parser.add_argument("--canary", default="data/datasets/canary_prompts.jsonl")
    parser.add_argument("--output", default="data/datasets/golden_eval_set.jsonl")
