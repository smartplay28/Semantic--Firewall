"""
Experiment 7c: Chunked Ablation Recovery 2
====================================================
Resumes the ablation study after the second server reboot.
We have F1 and Latency for Configs 1-6 from the logs.
We will execute Configs 7-8 directly and combine the results.
"""
import os
import sys
import time
...
def main():
    print_header("EXPERIMENT 7c: CHUNKED ABLATION RECOVERY 2")
    ...
    results = {
        ...
        "Regex + Cache": {"metrics": {"accuracy": 0.917, "precision": 0.917, "recall": 0.917, "f1": 0.9170}, "avg_latency_ms": 28414.28},
        "Regex + Parallel Detectors": {"metrics": {"accuracy": 0.944, "precision": 0.944, "recall": 0.944, "f1": 0.9440}, "avg_latency_ms": 26141.73}
    }
    ...
    print("Recovery 2 Ablation Complete!")
