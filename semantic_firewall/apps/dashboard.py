...
from semantic_firewall.core.orchestrator.document_extractor import DocumentExtractor
from semantic_firewall.core.orchestrator.orchestrator import SemanticFirewallOrchestrator
from semantic_firewall.ui.pages.batch_page import render_batch_tab as render_batch_tab_page
from semantic_firewall.ui.pages.document_page import render_document_tab as render_document_tab_page
from semantic_firewall.ui.pages.history_page import (
    render_history_tab as render_history_tab_page,
    render_stats_tab as render_stats_tab_page,
)
from semantic_firewall.ui.pages.policy_page import render_policy_tab as render_policy_tab_page
from semantic_firewall.ui.pages.review_page import render_review_tab as render_review_tab_page
from semantic_firewall.ui.pages.rules_page import render_rules_tab as render_rules_tab_page
...
def load_public_leaderboard():
    leaderboard_path = Path("data/results/leaderboard.json")
...
def run_benchmark_pipeline() -> tuple[bool, str]:
    ...
    commands = [
        [sys.executable, "semantic_firewall/benchmarks/extract_dataset_from_tests.py"],
        [sys.executable, "semantic_firewall/benchmarks/run_market_benchmark.py"],
    ]
    logs = []
