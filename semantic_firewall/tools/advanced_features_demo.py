...
def test_self_healing_allowlist():
    print("="*60)
    print("ðŸ§ª TESTING: SELF-HEALING SEMANTIC ALLOWLIST")
    print("="*60)
    ...
    fw._local.semantic_cache.add_allowlist(false_positive_prompt, reason="Approved political science essay")
    ...
    print(f"Latency: {decision3.processing_time_ms:.1f}ms (Super fast because it skipped the LLM!)")


def test_multi_turn_escalation():
    print("\n" + "="*60)
    print("ðŸ§ª TESTING: MULTI-TURN ESCALATION TRACKING")
    print("="*60)
