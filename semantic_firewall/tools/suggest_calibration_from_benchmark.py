...
def main():
    ...
    parser.add_argument("--results", default="data/results/benchmark_results.json")
    parser.add_argument("--tool-name", default="Semantic Firewall (balanced)")
    parser.add_argument("--output", default="data/results/calibration_recommendations.json")
