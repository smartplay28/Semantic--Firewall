...
# Allow running as a standalone script: `python semantic_firewall/tools/suggest_threshold_tuning.py`
...
def main():
    ...
    parser.add_argument("--db-path", default="data/var/audit.db")
    parser.add_argument("--workspace-id", default=None)
    parser.add_argument("--min-count", type=int, default=2)
    parser.add_argument("--limit", type=int, default=200)
    parser.add_argument("--output", default="data/results/threshold_tuning_recommendations.json")
