...
def save_report(reports: List[AgentReport], output_path: str = "evaluation_report.json"):
...
def save_markdown_report(reports: List[AgentReport], output_path: str = "evaluation_report.md"):
    lines = [
...
if __name__ == "__main__":
    custom_rules_path = Path("evaluation_custom_rules.json")
