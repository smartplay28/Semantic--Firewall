...
def render_stats_tab():
    ...
    if leaderboard_rows:
        ...
        st.plotly_chart(fig, use_container_width=True)
        st.caption("Leaderboard source: leaderboard.json (manual baseline entries, not auto-benchmarked).")
    else:
        st.info("No leaderboard rows found. Add entries to leaderboard.json.")
